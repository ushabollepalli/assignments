...
//click on apply button in leave page
...
//finding the count of applied leaves
var startdate;
var enddate;
var datesarray = [];
...
//apply button access condition checking
var finaladd = 0;
var previousarray = [];
var flag = false;
var bufferarray = [];
...
document.getElementById("leavehistory").onclick = function () {
...
document.getElementById("holidaylist").onclick = function () {
	document.getElementById("tables").style.display = "block";
	document.getElementById("leavepage").style.opacity = "0.1";
}
document.getElementById('holidayclose').onclick = function () {
	document.getElementById("tables").style.display = 'none';
	document.getElementById("leavepage").style.opacity = "1";
}

document.getElementById("optionallist").onclick = function () {
	document.getElementById("optionaltable").style.display = "block";
	document.getElementById("leavepage").style.opacity = "0.1";
}
document.getElementById('optionalclose').onclick = function () {
